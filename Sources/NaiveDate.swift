...
public struct NaiveDate: Equatable, Hashable, Comparable, LosslessStringConvertible, Codable, _DateComponentsConvertible {
    ...
    public init(from decoder: Decoder) throws {
        if let container = try? decoder.container(keyedBy: CodingKeys.self),
           let year = try? container.decode(Int.self, forKey: CodingKeys.year),
           let month = try? container.decode(Int.self, forKey: CodingKeys.month),
           let day = try? container.decode(Int.self, forKey: CodingKeys.day) {
            self.year = year
            self.month = month
            self.day = day
        } else {
...
public struct NaiveTime: Equatable, Hashable, Comparable, LosslessStringConvertible, Codable, _DateComponentsConvertible {
    ...
    public init(from decoder: Decoder) throws {
        if let container = try? decoder.container(keyedBy: CodingKeys.self),
           let hour = try? container.decode(Int.self, forKey: CodingKeys.hour),
           let minute = try? container.decode(Int.self, forKey: CodingKeys.minute),
           let second = try? container.decode(Int.self, forKey: CodingKeys.second) {
            self.hour = hour
            self.minute = minute
            self.second = second
        } else {
...
public struct NaiveDateTime: Equatable, Hashable, Comparable, LosslessStringConvertible, Codable, _DateComponentsConvertible {
    ...
    public init(from decoder: Decoder) throws {
        if let container = try? decoder.container(keyedBy: CodingKeys.self),
          let date = try? container.decode(NaiveDate.self, forKey: CodingKeys.date),
          let time = try? container.decode(NaiveTime.self, forKey: CodingKeys.time) {
            self.date = date
            self.time = time
        } else {
            self = try _decode(from: decoder)
